...
"""PyCalc is a simple calculator built using Python and PyQt5.
    This code was avaiable at: https://realpython.com/python-pyqt-gui-calculator/
"""


import sys
# Used to connect signals with methosds that need to take extra arguments
...
class PyCalcUi(QMainWindow):
    ...
    def _createDisplay(self):
        ...
        self.display.setAlignment(Qt.AlignRight) # Show the text as left aligned
    ...
    def setDisplayText(self, text): 
        ...
        self.display.setFocus()     # Set the cursor focus
